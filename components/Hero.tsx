      ...
      <div className="max-w-4xl mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center gap-8 lg:gap-12">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <h1 className="text-3xl lg:text-5xl font-extrabold tracking-tight text-zinc-900 dark:text-white mb-4">
              Hi, saya{" "}
            ...
            <p className="text-base lg:text-lg text-zinc-600 dark:text-zinc-400 leading-relaxed mb-6">
              Website Portofolio resmi saya. Silakan jelajahi beberapa{" "}
              <strong className="text-zinc-900 dark:text-white font-semibold">
                Project
              </strong>{" "}
              unggulan saya. Jika Anda tertarik untuk berkolaborasi atau
              mendiskusikan ide menarik, mari terhubung!
            </p>
